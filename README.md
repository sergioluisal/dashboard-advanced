...
- Classificação de status discente
...
Responsável pelos componentes gráficos e interativos.

- Cards de KPIs
- Gráficos do tipo Donut (Mestrado vs Doutorado)
...
- Filtro por Programa
- Filtro por Curso
- Filtro por Status (Ativo, Titulado, Desligado)
...
Alunos Ativos	Discentes regularmente matriculados
Alunos Titulados	Discentes com conclusão formal
Taxa de Titulação	Percentual de conclusão
